...
const ExperienceGallery = ({ experience, onClose }) => {
  ...
  const { images, description, timePeriod, title } = experience;
    ...
    >
      ...
      >
        ...
        <div className="mt-4 max-w-2xl mx-auto text-center">
          <h5 className="text-md font-bold text-gray-600 mb-2">{experience.company}</h5>
          <h4 className="text-lg font-medium text-blue-500 mb-1">{experience.jobTitle}</h4>
